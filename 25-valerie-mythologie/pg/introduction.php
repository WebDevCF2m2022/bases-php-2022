...
<body>
    ...
    <h1>Mythologie</h1>
        ...
        <h2>Définition de mythologie</h2>
            <p>nom féminin
            <br>- Ensemble des mythes, des légendes (propres à un peuple, à une civilisation, à une religion). 
            <br>- Étude des mythes.
        ...
        <h3>La mythologie comme ensemble de mythes</h3>
            ...
            <ul>
                <li>mythologies d’Afrique : berbère, dogon (voir Dogons), égyptienne, kabyle, malgache (voir Madagascar), touareg (voir Touaregs) ;</li>
                <li>mythologies d’Amérique : abénaquise, aztèque, chilote, guaranie, inca, inuite, maya, précolombienne ;</li>
                <li>mythologies d’Extrême-Orient : chinoise, coréenne, japonaise, hindoue ;</li>
                <li>mythologie d’Océanie : aborigène, maori, nauruane ;</li>
                <li>mythologies d’Europe de l'Est : arménienne (voir Paganisme arménien), estonienne, magyare, lettone, ossète, slave ;</li>
                <li>mythologies d’Europe du Nord : finnoise, laponne (voir Religion rellamii), nordique ;</li>
                <li>mythologies d'Europe du Sud : cantabre, étrusque, grecque, romaine ;</li>
                <li>mythologies d’Europe de l'Ouest : bretonne, celtique, celtique (brittonique, gauloise, irlandaise), germanique, basque, pyrénéenne, suisse ;</li>
                <li>mythologies des Proche et Moyen-Orient : arabe, hourrite (voir Hourrites), mésopotamienne, hittite, ougaritique, persane ;</li>
                <li>mythologies des religions monothéistes : mythologie biblique, mythologie chrétienne, mythologie juive, mythologie islamique.</li>
            </ul>
            </p>
