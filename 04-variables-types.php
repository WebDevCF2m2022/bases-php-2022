...
<body>
    <h1>Les types de variables</h1>
        ...
        <?php
        // création de la variable (ici en camelCase), avec le = qui donne la valeur. En procédural, le typage strict n'est pas obligatoire mais c'est une norme à peu près établie -> bonne pratique
        ...
        $mySecondInt = - 7;</pre>
            ...
            <p>Ils ont le type float, attention en cas de calcul en base 10, on peut avoir des erreurs du au fait que les ordinateurs travaillent sur les calculs en base 16!<br> 
            On utilise le . et pas la , comme séparateur ! <a href="https://floating-point-gui.de/" target="_blank">What Every Programmer Should Know About Floating-Point Arithmetic</a></p>

            <?php
            $firstFloat = 8.27;
            $secondFloat = -79.789435185755468; // il manque 3 caractères car le nombre de chiffres derrière la virgule est trop grand
        ?>
