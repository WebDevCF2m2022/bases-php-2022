...
Les noms de variables suivent les mêmes règles de nommage que les autres entités PHP. Un nom de variable valide doit commencer par une lettre ou un underscore (_) mais on va l'éviter car les superglobales l'utilisent, et l'OO (orienté objet aussi), suivi de lettres, chiffres ou soulignés.</p>
<p>On va éviter les caractères spéciaux, même si certains sont valides. il faut absolument éviter les signes servant aux calculs (+-*/). De base l'ordinateur est une super calculatrice, du coup il interprète comme calcul tout ce qui ressemble à un calcul.</p>
...
<h4>Exercice: Mettez les variables valides (même les déconseillées) dans les balises PHP</h4>
<pre>
    $lulu = 5;
    $lala = "yes";
